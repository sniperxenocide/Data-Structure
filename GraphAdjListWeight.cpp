...
void Graph::addEdge(int u, int v,int w)
{
	...
	if(!directed) {adjList[v].insertItem(u) ; weight[v].insertItem(w);}
}

void Graph::removeEdge(int u, int v)
{
    adjList[u].removeItem(v);
    weight[u].removeItem(weight[u].getItem(v));
    if(!directed) {adjList[v].removeItem(u); weight[v].removeItem(weight[v].getItem(u));}
    this->nEdges--;
    //write this function
}
